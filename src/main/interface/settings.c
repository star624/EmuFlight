...
// PG_PID_PROFILE
    ...
    { "airmode_min_slow_authority", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { AIRMODE_AUTHORITY_MIN, 120 }, PG_PID_PROFILE, offsetof(pidProfile_t, airmode_min_slow_authority) },
    ...
    { "airmode_med_slow_authority", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { AIRMODE_AUTHORITY_MIN, 120 }, PG_PID_PROFILE, offsetof(pidProfile_t, airmode_med_slow_authority) },
    ...
    { "airmode_max_slow_authority", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { AIRMODE_AUTHORITY_MIN, 120 }, PG_PID_PROFILE, offsetof(pidProfile_t, airmode_max_slow_authority) },
